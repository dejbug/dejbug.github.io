...
Basically you load an xml file that happens to be an RSS or Atom feed and this Web Extension will make it humanly readable. If it recognizes the feed's source it will apply stylesheets that match the source's corporate identity.
